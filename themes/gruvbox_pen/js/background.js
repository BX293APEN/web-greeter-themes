...
export class Backgrounds {
    ...
    updateBackgroundImages() {
        ...
        if (defaultBackgrounds.includes(imagePath)) {
            this._backgroundElement.style.backgroundSize = "contain";
            this._backgroundElement.style.backgroundPosition = "center";
            this._backgroundElement.style.backgroundRepeat = "no-repeat";
        }
        else {
